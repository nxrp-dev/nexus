...
begin
  TNXCommandLine.RegisterFlag('mode', False, True, 'std',
    'Communication transport mode',
    'Use /mode=std for stdio transport or /mode=tcp for TCP/IP transport.');
  TNXCommandLine.RegisterFlag('host', False, True, '127.0.0.1',
