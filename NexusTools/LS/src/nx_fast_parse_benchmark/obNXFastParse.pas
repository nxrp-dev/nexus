...
{
  I usually loathe comments but making an exception in this case.
  This is a collection of highly efficient data structures with targeted
  purpose for specific parser behaviors.

  As an example across the sample set TNXFastStringSet improved keyword discovery
  from 4000ms to 172ms.
}
