...
begin
  ...
  FLocalSourceDirs := TStringList.Create;
  FLocalSourceDirs.CaseSensitive := False;
...
procedure TNXPasWorkspaceIndex.AddSourceDirectory(const AFileName: string);
var
  lDir: string;
begin
