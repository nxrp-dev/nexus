program NexusBindingTests;

{$mode objfpc}{$H+}

uses
  SysUtils, obNXTestRegistry, obNXTestSuite, obNXTestResult,
  tsNXBindingContracts, tsNXBindingSourceTests;
...
begin
  ...
  lFailed := 0;
  try
    RegisterBindingContracts(lRegistry);
    RegisterBindingSourceTests(lRegistry);
