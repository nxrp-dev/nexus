...
```powershell
fpc -B -FuNexusLib\packages\network\src\xmpp -FuNexusLib\packages\network\external\synapse -FuC:\lazarus\fpc\3.2.2\units\x86_64-win64\fcl-xml -FuC:\lazarus\fpc\3.2.2\units\x86_64-win64\hash -FUoutput\NexusNetXMPPLiveTest\units -FEoutput\NexusNetXMPPLiveTest\bin NexusLib\packages\network\tests\NexusNetXMPPLiveTest.lpr
```

The manual console target is clean-built with:

```powershell
fpc -B -FuNexusLib\packages\network\src\xmpp -FuNexusLib\packages\network\external\synapse -FuC:\lazarus\fpc\3.2.2\units\x86_64-win64\fcl-xml -FuC:\lazarus\fpc\3.2.2\units\x86_64-win64\hash -FUoutput\NexusXMPPConsole\units -FEoutput\NexusXMPPConsole\bin NexusLib\packages\network\examples\xmpp\NexusXMPPConsole.lpr
```
